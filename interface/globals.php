...
$logocode = "<img class='img-responsive center-block' src='" . $GLOBALS['OE_SITE_WEBROOT'] . "/images/login_logo.jpg'>";
$faviconcode = "<link rel='shortcut icon' href='".$GLOBALS['OE_SITE_WEBROOT']."/images/favicon.ico'>";
