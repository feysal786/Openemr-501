...
// feysal Que Top 1/6 pass doctorNo to demographics
 function newEvt1() {
...
///// EXTRA ADDED BY YOUSUF Not working in Firefox
 /* var lastFile_Parts = document.referrer.split('/');
 var lastFile = lastFile_Parts[lastFile_Parts.length - 1];

 if( lastFile  === "new_comprehensive_save.php")
    newEvt1();
 */
////////
...
?>
//feysal auto apointment new patient
if(Count==0){newEvt1();}
//if(Count==1){newEvt8();}
...
///////////////////////
 ...
 //       $widgetButtonLabel = xl("Edit");
 //       $widgetButtonLink = "../reminder/clinical_reminders.php?patient_id=".$pid;;
        $widgetButtonLabel = xl("Dr. Sumaira");
       ...
       // echo "<div style='margin-left:10px' class='text'><image src='../../pic/ajax-loader.gif'/></div><br/>";
        ...
        $widgetButtonLabel = xl("Dr. Zulfiqar");
