...
// feysal Que Top 1/6 pass doctorNo to demographics
 function newEvt1() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=72', '_blank', 775, 500);
  return false;
 }
  function newEvt2() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=71', '_blank', 775, 500);
  return false;
 }
   function newEvt3() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=74', '_blank', 775, 500);
  return false;
 }
   function newEvt4() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=77', '_blank', 775, 500);
  return false;
 }
   function newEvt5() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=70', '_blank', 775, 500);
  return false;
 }
    function newEvt6() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=76', '_blank', 775, 500);
  return false;
 }
    function newEvt7() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=75', '_blank', 775, 500);
  return false;
 }
    function newEvt8() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&doctorNo=9', '_blank', 775, 500);
  return false;
 }
