...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt11()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php
	    $widgetTitle = xl("Dr. Sumaira");
        $widgetLabel = "Dr. Sumaira";
 //       $widgetButtonLabel = xl("Edit");
 //       $widgetButtonLink = "../reminder/clinical_reminders.php?patient_id=".$pid;;
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt1();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt21()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php		
        $widgetTitle = xl("Dr. Zaman");
        $widgetLabel = "Dr. Zaman";
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt2();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "summary_item small";
        $widgetAuth = true;
...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt31()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php
        $widgetTitle = xl("Dr. Jamal");
        $widgetLabel = "Dr. Jamal";
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt3();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "summary_item small";
        $widgetAuth = true;
...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt41()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php
        $widgetTitle = xl("Dr. Adil");
        $widgetLabel = "Dr. Adil";
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt4();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "summary_item small";
        $widgetAuth = true;
...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt51()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php
        $widgetTitle = xl("Dr. Zulfiqar");
        $widgetLabel = "Dr. Zulfiqar";
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt5();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "summary_item small";
        $widgetAuth = true;
...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt61()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php
        $widgetTitle = xl("Dr. Aamir");
        $widgetLabel = "Dr. Aamir";
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt6();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "summary_item small";
        $widgetAuth = true;
...
?>
            ...
            <a class='css_button_small'
			   onclick='return newEvt71()'>
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>

<?php
        $widgetTitle = xl("Dr. Aslam");
        $widgetLabel = "Dr. Aslam";
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt7();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "summary_item small";
        $widgetAuth = true;
