...
<script type="text/javascript" language="JavaScript">
 ...
 function oldEvt(apptdate, eventid) {
   ...
   document.location.href = '../../main/calendar/add_edit_event.php?date=' + apptdate + '&eid=' + eventid, '_blank';
 }
...
// feysal Que Top 1/6 pass doctorNo/&userid=6&autosave to demographics
 function newEvt6() {

  //dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=6&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=6&autosave=1&apptStatus=@ ', '_new' ;
  //document.location.href = 	'../../patient_file/front_payment.php?userid=6 ' ;
  return false;
 }
  function newEvt7() {

 // dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=7&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=7&autosave=1&apptStatus=@ ', '_new' ;
  //  document.location.href = 	'../../patient_file/front_payment.php?userid=7 ' ;
  return false;
 }
   function newEvt8() {

  //dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=8&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=8&autosave=1&apptStatus=@ ', '_new' ; 
 //document.location.href = 	'../../patient_file/front_payment.php?userid=8 ' ;
  return false;
 }
   function newEvt9() {

 // dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=9&autosave=1', '_blank', 775, 500);
   document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=9&autosave=1&apptStatus=@ ', '_new' ;
 // document.location.href = 	'../../patient_file/front_payment.php?userid=9 ' ;
  return false;
 }
   function newEvt10() {

 // dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=10&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=10&autosave=1&apptStatus=@ ', '_new' ;
 //  document.location.href = 	'../../patient_file/front_payment.php?userid=10 ' ;
  return false;
 }
    function newEvt11() {

//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=11&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=11&autosave=1&apptStatus=@ ', '_new' ;
//  document.location.href = 	'../../patient_file/front_payment.php?userid=11 ' ;
  return false;
 }
    function newEvt12() {

//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=12&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=12&autosave=1&apptStatus=@ ', '_new' ;
//  document.location.href = 	'../../patient_file/front_payment.php?userid=12 ' ;
  return false;
 }
    function newEvtB() {

  //feysal open in new tab
  document.location.href = 	'../../patient_file/front_payment.php ' ;
  //dlgopen('../../patient_file/front_payment.php ', '_blank', 775, 500);
  return false;
 }
     function newEvt13() {

 // dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=13&autosave=1', '_blank', 775, 500);
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=13&autosave=1&apptStatus=@ ', '_new' ;
 //  document.location.href = 	'../../patient_file/front_payment.php?userid=13 ' ;
  return false;
 }
      function newEvt14() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=14&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt15() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=15&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt16() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=16&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt17() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=17&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt18() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=18&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt19() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=19&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt20() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=20&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt21() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=21&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt22() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=22&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
       function newEvt23() {
  document.location.href = 	'../../main/calendar/add_edit_event.php?patientid= <?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=23&autosave=1&apptStatus=@ ', '_new' ;
  return false;
 }
...
//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=6&apptStatus=-', '_blank', 775, 500);
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=6', '_blank';
  return false;
 }
   function newEvt7a() {
//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=7&apptStatus=-', '_blank', 775, 500);
   document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=7', '_blank';
 return false;
 }
   function newEvt8a() {
//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=8&apptStatus=-', '_blank', 775, 500);
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=8', '_blank';
  return false;
 }
   function newEvt9a() {
//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=9&apptStatus=-', '_blank', 775, 500);
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=9', '_blank';
  return false;
 }
   function newEvt10a() {
//  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=10&apptStatus=-', '_blank', 775, 500);
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=10', '_blank';
  return false;
 }
   function newEvt11a() {
 // dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=11&apptStatus=-', '_blank', 775, 500);
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=11', '_blank';
  return false;
 }
   function newEvt12a() {
   //dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=12&apptStatus=-', '_blank', 775, 500);
   document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=12', '_blank';
   return false;
 }
    function newEvt13a() {
  //dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=13&apptStatus=-', '_blank', 775, 500);
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=13', '_blank'; 
 return false;
 }
     function newEvt14a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=14', '_blank'; 
 return false;
 }
      function newEvt15a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=15', '_blank'; 
 return false;
 }
      function newEvt16a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=16', '_blank'; 
 return false;
 }
      function newEvt17a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=17', '_blank'; 
 return false;
 }
      function newEvt18a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=18', '_blank'; 
 return false;
 }
      function newEvt19a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=19', '_blank'; 
 return false;
 }
      function newEvt20a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=20', '_blank'; 
 return false;
 }
      function newEvt21a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=21', '_blank'; 
 return false;
 }
      function newEvt22a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=22', '_blank'; 
 return false;
 }
      function newEvt23a() {
  document.location.href ='../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=23', '_blank'; 
 return false;
 }
...
<?php
// feysal To have only One Prescription Note when using button Notes
 $req = sqlQuery("SELECT form_id FROM forms WHERE encounter=". $encounter ." and form_name = 'Prescription Notes'");
 $formid=$req['form_id'];
?>
        var iam = top.tab_mode ? top.frames.editScripts : window[0];
        iam.location.href = "<?php echo $GLOBALS['webroot']?>/interface/patient_file/encounter/load_form.php?formname=LBFPrescription+Notes&id=<?php echo $formid; ?>"
    };
	var AddAppointment = function () {
        var iam = top.tab_mode ? top.frames.editScripts : window[0];
        iam.location.href = "<?php echo $GLOBALS['webroot']?>/interface/main/calendar/add_edit_event.php?patientid=<?php echo attr($pid); ?>"
    };
//feysal
...
//feysal increase 1000 length of window
    dlgopen(url, 'editScripts', w, 1000, '', '', {
        buttons: [
...
//feysal add buttons Notes and Appointment
			{text: '<?php echo xla('Notes'); ?>', close: false, style: 'primary  btn-sm', click: AddNotes},
			{text: '<?php echo xla('Appointment'); ?>', close: false, style: 'primary  btn-sm', click: AddAppointment},
...
<div style='margin-top:10px' class="main"> <!-- start main content div -->
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <div style='float:left; margin-right:20px'>
                    ...
                    <?php if (!$GLOBALS['hide_billing_widget']) { ?>
                        <tr>
                            <td>
                                <?php
		/* Feysal Removed Button and use Billing wedget
		$widgetTitle = xl("");
        $widgetLabel = "Billing & Payment";
        $widgetButtonLabel = xl("Billing & Payment");
        $widgetButtonLink = "return newEvt8();";
        $widgetButtonClass = "";
		...
		*/
                                ...
                                $widgetLabel = "billing";
                                $widgetButtonLabel = xl("Billing & Payment");
                                $widgetButtonLink = "return newEvtB();";
                                $widgetButtonClass = "";
                                $linkMethod = "javascript";
                                $bodyClass = "summary_item small";
                                $widgetAuth = true;
...
<?php if (acl_check('patients', 'notes')) { ?>
        <tr>
            <td width='650px' style="display:none" >
<?php
...
// feysal Que Top 5/6 Add Doctors Buttons
///////////////////////
 
foreach (array('primary') as $instype) {
    //$enddate = 'Present';
    $query = "SELECT * FROM users where authorized=1 and facility_id=3 " ;//.
    //"pid = ? AND type = ? " .
    //"ORDER BY date DESC";
    $res = sqlStatement($query);
	//print_r ($row['provider']);
    while ($row = sqlFetchArray($res)) {
		//print_r ($row['id']);		
?>

            <a class='css_button_small'
			   onclick="return newEvt<?php echo $row['id'] ;?>a()">
			   <span><?php echo htmlspecialchars(xl('Appointment'), ENT_NOQUOTES);?></span>
            </a>
...
<?php
		...
		//print_r ($row['provider']);
		//$abcd="aaaaaaaaaaaaaaaaaa";
	    $widgetTitle = $row['fname'] ;
        $widgetLabel = "Dr. Sumaira";
 //       $widgetButtonLabel = xl("Edit");
 //       $widgetButtonLink = "../reminder/clinical_reminders.php?patient_id=".$pid;;
        $widgetButtonLabel = xl("WalkIn");
        $widgetButtonLink = "return newEvt".$row['id']."();";
        $widgetButtonClass = "";
        $linkMethod = "javascript";
        $bodyClass = "css_button_small";
        $widgetAuth = true;
        $fixedWidth = true;
        expand_collapse_widget($widgetTitle, $widgetLabel, $widgetButtonLabel , $widgetButtonLink, $widgetButtonClass, $linkMethod, $bodyClass, $widgetAuth, $fixedWidth);
        //echo "<br/>";
