...
///////Appointment Button
  ...
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=6', '_blank', 775, 500);
   return false;
 }
   function newEvt21() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=7', '_blank', 775, 500);
   return false;
 }
   function newEvt31() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=8', '_blank', 775, 500);
   return false;
 }
   function newEvt41() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=9', '_blank', 775, 500);
   return false;
 }
   function newEvt51() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=10', '_blank', 775, 500);
   return false;
 }
   function newEvt61() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=11', '_blank', 775, 500);
   return false;
 }
   function newEvt71() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=12', '_blank', 775, 500);
   return false;
 }
    function newEvt91() {
  dlgopen('../../main/calendar/add_edit_event.php?patientid=<?php echo htmlspecialchars($pid,ENT_QUOTES); ?>&userid=13', '_blank', 775, 500);
   return false;
 }
 ///////
