...
<span class=title><?php echo ($GLOBALS['phone_country_code'] == '1') ? xl('') : xl('Coding'); ?></span>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="hidden" name="justify" value="<?php xl('Justify/Save','e');?>">
<?php } ?>
</dt>
</dl>
...
if ($result = getBillingByEncounter($pid,$encounter,"*") ) {
  ...
  $ndclino = 0;
	...
	$billing_html["CPT4"] .= "<tr><td>" . xl('Balance') . ":</td><td>" . oeFormatMoney($total) . "</td></tr>\n";
...
<a href="copay.php" target="Codes" onclick="top.restoreSession()">
<input type="button" name="lm" value="<?php xl('Payment','e'); ?>">
</a>
<a href="cash_receipt.php?" target='New' onclick='top.restoreSession()'>
<input type="button" name="lm" value="<?php xl('Print Receipt','e'); ?>">
</a>
</td>
</tr>
