...
<dd><a href="<?php echo $GLOBALS['webroot']?>/interface/patient_file/encounter/diagnosis.php?mode=add&type=CPT4&code=CONS5&modifier=&units=1&fee=500.00&text=Consult" target='Codes' onclick='top.restoreSession()'>
<input type="button" name="lm" value="<?php xl('5Consult','e'); ?>">
<a href="<?php echo $GLOBALS['webroot']?>/interface/patient_file/encounter/diagnosis.php?mode=add&type=CPT4&code=CONS3&modifier=&units=1&fee=300.00&text=Consult" target='Codes' onclick='top.restoreSession()'>
<input type="button" name="lm" value="<?php xl('3Consult','e'); ?>">
</a></dd>
...
<a href="<?php echo $GLOBALS['webroot']?>/interface/patient_file/encounter/diagnosis.php?mode=add&type=CPT4&code=PTINR&modifier=&units=1&fee=1500.00&text=PFT+INR" target='Codes' onclick='top.restoreSession()'>
<input type="button" name="lm" value="<?php xl('PFT+INR','e'); ?>">
