...
?>
<a href='/openemr/interface/patient_file/encounter/encounter_bottom.php' class='css_button' onclick='return clickCharges()'><span><?php echo xl('Bill & Prescription') ?></span></a>
<a href="<?php echo $GLOBALS['webroot']?>/controller.php?prescription&edit&id=&pid=<?php echo $pid?>" target='Codes' onclick='top.restoreSession()'>
