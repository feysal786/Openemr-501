...
?>
  ...
  <td nowrap id='tdrepeat1'style="display:none;" ><?php echo xlt('Repeats'); ?>
  </td>
  <td nowrap style="display:none;">
...
<tr id="days_every_week_row" style="display:none;">
    <td></td>
    <td></td>
...
<?php echo $prefcat_options ?>
  ...
  <td nowrap id='tdrepeat2'style="display:none;" ><?php echo xlt('until date'); ?>
  </td>
  <td nowrap style="display:none;">
