<?php /* Smarty version 2.6.31, created on 2019-04-24 20:05:03
         compiled from /homepages/2/d766239827/htdocs/public_html/afc/templates/prescription/general_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'headerShow', '/homepages/2/d766239827/htdocs/public_html/afc/templates/prescription/general_list.html', 13, false),array('function', 'xl', '/homepages/2/d766239827/htdocs/public_html/afc/templates/prescription/general_list.html', 116, false),array('modifier', 'escape', '/homepages/2/d766239827/htdocs/public_html/afc/templates/prescription/general_list.html', 136, false),)), $this); ?>
<html>
<head>
...
" onclick="top.restoreSession()" class="css_button"><span><?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Preview')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
...
<table width="100%" class="showborder_head" cellspacing="0px" cellpadding="2px">
    <tr>
       <!-- TajEmo Changes 2012/06/14 02:01:43 PM by CB added Heading for checkbox column -->
		...
		<th width="8px">&nbsp;</th>
        <th style="display: none;" width="70px"><?php echo smarty_function_xl(array('t' => ((is_array($_tmp='RxNorm')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
</th>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Changed')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
</th>
...
.</th>
        ...
        <th><?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Doctor')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
</th>
        <?php if ($this->_tpl_vars['GLOBALS']['weno_rx_enable']): ?>
...
">
    ...
    <td style="display: none;" class="editscript"  id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
