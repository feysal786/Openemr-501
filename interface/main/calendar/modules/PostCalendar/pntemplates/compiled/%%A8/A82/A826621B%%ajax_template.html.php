<?php /* Smarty version 2.6.31, created on 2019-04-25 15:58:54
         compiled from default/views/month/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/month/ajax_template.html', 10, false),array('modifier', 'date_format', 'default/views/month/ajax_template.html', 345, false),array('modifier', 'string_format', 'default/views/month/ajax_template.html', 346, false),)), $this); ?>
...
if (count($facilities) > 1) {
    ...
    if (!$GLOBALS['restrict_user_facility']) echo "    <option value='0' $selected>" . xl('All Clincs') . "</option>\n";
