...
<script type="text/html" id="patient-data-template">
    <div>
        <span class="patientDataColumn">
			...
			<span class="float-element"><a data-bind="click: viewPtFinder2" href="#" class="btn btn-default btn-sm">
        ...
        <!-- ko with: patient -->
            ...
            <div class="patientCurrentEncounter">
                <span><?php echo xlt("Open Visit"); ?>:</span>
                ...
                <!-- ko if:!selectedEncounter() -->
                    ...
                    <span style="color:red;text-align:center;">No Visit Selected</span>
                <!-- /ko -->
            </div>
