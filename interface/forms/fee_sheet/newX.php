...
if ($GLOBALS['sell_non_drug_products']) {
    ...
    $tres = sqlStatement("SELECT d.drug_id, d.name, SUM(di.on_hand) as on_hand " .
    " FROM drugs AS d, drug_inventory AS di WHERE " .
    " d.drug_id = di.drug_id and di.destroy_date is Null GROUP BY d.name, d.size, d.form " .
    "ORDER BY d.drug_id");
...
<?php } ?>
  ...
  <td class='billcell' align='center'><b><?php echo xlt('Units');?></b></td>
    <td class='billcell'><b><?php echo xlt('QOH');?></b></td>
<?php } ?>
