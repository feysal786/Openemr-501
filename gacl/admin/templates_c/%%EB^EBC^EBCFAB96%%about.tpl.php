<?php /* Smarty version 2.6.31, created on 2019-05-24 11:12:07
         compiled from phpgacl/about.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'phpgacl/about.tpl', 62, false),)), $this); ?>
        ...
        <?php endif; ?>
          ...
          <tr>
    		...
    		<form method="post" name="about" action="about.php" align="center">
				<textarea name="system_information" rows="10" cols="60" wrap="VIRTUAL"><?php echo ((is_array($_tmp=$this->_tpl_vars['system_info'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</textarea>
				<br />
				<input type="hidden" name="system_info_md5" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['system_info_md5'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" />
		...
		<?php if ($this->_tpl_vars['first_run'] != 1): ?>
          ...
          <tr>
			<td>
<pre>
<?php echo ((is_array($_tmp=$this->_tpl_vars['credits'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
