<?php /* Smarty version 2.6.31, created on 2019-05-24 11:04:20
         compiled from phpgacl/edit_group.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'phpgacl/edit_group.tpl', 25, false),array('modifier', 'escape', 'phpgacl/edit_group.tpl', 32, false),array('function', 'html_options', 'phpgacl/edit_group.tpl', 28, false),)), $this); ?>
      ...
      <table cellpadding="2" cellspacing="2" border="2" width="100%">
        <tbody>
          ...
          <tr valign="top">
            ...
            <td>
                <input type="text" class="group-name" size="50" name="name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
">
            </td>
            <td>
                <input type="text" class="group-value" size="50" name="value" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
">
            </td>
          </tr>
    ...
    <input type="hidden" name="group_id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
">
